namespace laba1
{
    partial class itemsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.items.AutoGenerateColumns = false;
            ...
            this.items.DataSource = this.itemsBindingSource;
            ...
            this.items.Size = new System.Drawing.Size(544, 232);
            this.items.TabIndex = 2;
            this.toolTip1.SetToolTip(this.items, "таблица заказов");
            this.items.SelectionChanged += new System.EventHandler(this.items_SelectionChanged);
            this.items.HelpRequested += new System.Windows.Forms.HelpEventHandler(this.items_HelpRequested);
            // 
            ...
            this.itemsBindingSource.DataSource = this.dbdemosDataSet;
            // 
            // dbdemosDataSet
            // 
            ...
            this.bindingNavigator1.Location = new System.Drawing.Point(0, 346);
            ...
            this.toolTip1.SetToolTip(this.bindingNavigator1, "панель навигации для таблицы товаров");
            // 
